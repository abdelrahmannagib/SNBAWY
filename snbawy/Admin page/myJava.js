  ...
  if (x.style.fontSize === "16px") 
   {
    ...
    document.getElementById("admin").style.fontSize="20px";
   ...
   else 
   {
    ...
    document.getElementById("admin").style.fontSize="16px";
  ...
  if (x.style.fontStyle === "normal") 
   {
    ...
    document.getElementById("admin").style.fontStyle ="italic";
   }
   else 
   {
    ...
    document.getElementById("admin").style.fontStyle ="normal";
